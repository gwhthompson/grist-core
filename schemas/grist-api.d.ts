/**
 * Grist API Type Definitions - v2.0.1
 *
...
// ============================================================================
// Ready Payload for Custom Widgets
// ============================================================================

/**
 * Options that can be passed to grist.ready() to configure widget behavior
 */
export interface ReadyPayload {
  ...
  requiredAccess?: string;
  /**
   * Columns that the widget expects to be mapped
   */
  columns?: ColumnsToMap;
  /**
   * Whether the widget should appear as a linking source
   */
  allowSelectBy?: boolean;
  /**
   * Callback for when the user clicks "Open configuration"
   */
